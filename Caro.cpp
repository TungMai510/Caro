...
public:
    ...
    void makeMove(Board& board) {
        ...
        do {
            int row, col;
            cout << name << ", nhap dong va cot (1-3): ";
            cin >> row >> col;
            ...
            if (!validMove) {
                cout << "O nay da duoc danh dau. Vui long chon o khac." << endl;
            }
...
public:
    ...
    void makeMove(Board& board) {
        ...
        cout << "May da dat '" << symbol << "' o hang " << row + 1 << ", cot " << col + 1 << endl;
    }
};
...
public:
    ...
    void start() {
        ...
        while (!gameEnded) {
            board.draw();
            cout << "Luot cua " << currentPlayer->getName() << ": " << endl;
            currentPlayer->makeMove(board);
            if (board.checkWin(currentPlayer->getSymbol())) {
                board.draw();
                cout << currentPlayer->getName() << " Thang!" << endl;
                gameEnded = true;
            }
...
void menu() {
    ...
    do {
        ...
        cout << "1. Nguoi choi voi may" << endl;
        cout << "2. Nguoi choi voi nguoi" << endl;
        cout << "3. May choi voi may" << endl;
        cout << "Nhap lua chon: ";
        cin >> choice;
    ...
    do {
        cout << "Chon ky hieu (X hoac O) cho player 1: ";
        cin >> symbolChoice;

        if (symbolChoice != "X" && symbolChoice != "O") {
            cout << "Ky hieu khong hop le. Vui lòng chon lai." << endl;
        }
        else {
            validSymbol = true;
        }
    ...
    if (choice == 1) {
        ...
        player2 = new HumanPlayer((symbolChoice[0] == 'X' ? 'O' : 'X'), "Nguoi choi 2");
    }
...
int main() {
    ...
    do {
        ...
        int option;
        do {
            cout << "Ban muon quay lai menu chon che do choi khong?" << endl;
            cout << "1. Co" << endl;
            cout << "2. Khong" << endl;
            cout << "Nhap lua chon: ";
            cin >> option;
